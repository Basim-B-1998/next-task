...
const mobile = params.get("mobile");
  ...
  return (
    <>
       ...
       <label htmlFor="upload" className="border border-dashed text-xs p-5 ml-15">Add Your Profile picture</label>
       <input className="border mt-15 w-3/4 h-12" type="text" placeholder="Enter your Full Name" value={form.name} onChange={(e)=>setForm({...form,name:e.target.value})}/>
